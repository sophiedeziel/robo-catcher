class HardwareController < ApplicationController
  ...
  def update
    ...
    start_process("ruby lib/sequences/trash.rb zero_motors") if params.require(:commit) == "Raise motors"
    start_process("ruby lib/sequences/trash.rb raise_motors") if params.require(:commit) == "Center motors"
